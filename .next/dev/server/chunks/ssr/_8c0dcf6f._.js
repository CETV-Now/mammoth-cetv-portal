...
function ChannelPicker({ alreadySelected, onAdd, open, onOpenChange }) {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: CHANNELS.map((channel)=>{
                        const isAlready = alreadySelected.includes(channel);
                        const isPending = pendingNames.includes(channel);
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "button",
                            disabled: isAlready,
...
;
;
function PlaylistForm({ mode, playlist, content, screens, assignedScreenIds = [] }) {
    ...
    function handleChannelAdd(names) {
        setChannelItems((prev)=>{
            const existing = new Set(prev.map((c)=>c.name));
            const newItems = names.filter((n)=>!existing.has(n)).map((n)=>({
                    name: n
                }));
            return [
                ...prev,
        ...
        try {
            ...
            const res = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    channels: channelItems.map(({ name })=>({
                            id: null,
                            name
                        })),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Add your uploaded images and videos. There is no limit on the number of items you can add."
                                    }, void 0, false, {
                                        fileName: "[project]/app/playlists/components/playlist-form.tsx",
                                        lineNumber: 227,
                                        columnNumber: 13
...
//# sourceMappingURL=_8c0dcf6f._.js.map