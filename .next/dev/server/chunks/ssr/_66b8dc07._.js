...
(()=>{
    const e = new Error("Cannot find module './channel-picker'");
...
function PlaylistForm({ mode, playlist, content, screens, assignedScreenIds = [] }) {
    ...
    const [playlistItems, setPlaylistItems] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](()=>playlist?.content?.map((item)=>({
                ...
                id: item.id,
                name: item.name,
                url: item.type === "content" ? content.find((c)=>c._id === item.id)?.url : undefined,
                mime_type: item.type === "content" ? content.find((c)=>c._id === item.id)?.mime_type : undefined
            })) ?? []);
    ...
    function handleContentAdd(selectedIds) {
        const newItems = selectedIds.filter((id)=>!playlistItems.some((p)=>p.id === id && p.type === "content")).map((id)=>{
    ...
    function handleChannelAdd(channelNames) {
        const newItems = channelNames.filter((name)=>!playlistItems.some((p)=>p.type === "channel" && p.name === name)).map((name)=>({
                localKey: crypto.randomUUID(),
                type: "channel",
                id: null,
                name
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const res = await fetch(url, {
                ...
                body: JSON.stringify({
                    name: name.trim(),
                    content: playlistItems.map(({ type, id, name })=>({
                            type,
                            id,
                            name
                        })),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$playlists$2f$components$2f$content$2d$picker$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ContentPicker"], {
                content: content,
                alreadySelected: playlistItems.filter((p)=>p.type === "content").map((p)=>p.id),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ChannelPicker, {
                alreadySelected: playlistItems.filter((p)=>p.type === "channel").map((p)=>p.name),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: item.type === "content" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ContentThumbnail, {
                    url: item.url,
...
//# sourceMappingURL=_66b8dc07._.js.map