...
"[project]/app/api/locations/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    let locationId;
    try {
        locationId = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](id);
    } catch  {
        return Response.json({
...
async function DELETE(_req, { params }) {
    ...
    if (activeScreenCount > 0) {
        return Response.json({
            error: "Cannot delete a location that has screens"
        }, {
            status: 409
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d2965bf6._.js.map