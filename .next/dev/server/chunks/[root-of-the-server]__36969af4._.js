...
"[project]/app/api/onboarding/ad-mode/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req) {
    ...
    if (!adServingMode) {
        return Response.json({
            error: "adServingMode is required"
        }, {
            status: 400
        });
    }
    ...
    if (screenId) {
        await db.collection("screens").updateOne({
            _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$29$__["ObjectId"](screenId),
            account_id: user.account_id
        }, {
            $set: {
                ad_serving_mode: adServingMode,
                updated_at: now
            }
        });
    } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__36969af4._.js.map