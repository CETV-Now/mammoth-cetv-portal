...
function StepLocation({ onComplete }) {
    ...
    const { ready, value: addressInput, suggestions: { status, data: predictions }, setValue: setAddressInput, clearSuggestions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$places$2d$autocomplete$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        requestOptions: {
            types: [
                "address"
            ]
...
_s(StepLocation, "SoyDtcsyZb6YNm+asEer+1jp3Ec=", false, function() {
    return [
...
//# sourceMappingURL=_b1f52aa2._.js.map